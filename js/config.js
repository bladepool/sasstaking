...
$.getJSON('https://arbitrum.api.0x.org/swap/v1/quote?buyToken=' + ADDRESS_SAS + '&sellToken=USDC&sellAmount=6197&excludedSources=Uniswap,BakerySwap,Belt,DODO,DODO_V2,Ellipsis,Mooniswap,MultiHop,Nerve,Smoothy,ApeSwap,CafeSwap,CheeseSwap,JulSwap,LiquidityProvider&slippagePercentage=0&gasPrice=0', function(data) {
    ...
    if (data && data.price) {
        ...
        $('#SAS-price').text("$ " + priceSAS.toFixed(8));
        $('#price').text("$ " + priceSAS.toFixed(8));
    }
    $('#SAS-price').text("$ " + priceSAS.toFixed(8));
    $('#price').text("$ " + priceSAS.toFixed(8));
